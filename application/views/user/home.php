...
<div class="container">
  <div class="owl-slider">
    <div id="carousel" class="owl-carousel banner-slider">
      <div class="item">
        <img class="owl-lazy" data-src="<?php echo base_url('assets/slider-image/banner_bg_jpg.jpg');  ?>" alt="">
      </div>
      <div class="item">
        <img class="owl-lazy" data-src="<?php echo base_url('assets/slider-image/login_bg.png');  ?>" alt="">
      </div>
