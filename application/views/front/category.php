...
<section class="main-page">
  <div class="container">
    <div class="row">
      <div class="col-md-3">      
       <?php require_once(APPPATH."views/front/category_sidebar_filter.php"); ?>
      </div>
      <div class="col-md-9" >
        <div class="row">
          <div class="col-md-3">            
            <h3><a href="<?php echo base_url('user'); ?>">Home</a> <i class="fa fa-angle-right fa-custom"></i> <a href=""><?php if(!empty($main_category)){ echo $main_category->category_name;} ?></a></h3>           
          </div>
          <div class="col-md-9">  
