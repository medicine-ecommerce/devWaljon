...
<body>
	...
	<section class="container-fluid login_doctor">
	  <div class="row">
	    <div class="col-md-8">       
	    </div>
	    <div class="col-md-4">
	      ...
	      <div class="content-box">        
	        <h6>Login</h6>
	        <form method="post" action="<?php echo base_url('doctor/doctorLogin');?>">
	        ...
	        <p>Don't have an account <a href="<?php echo base_url('doctor/doctorregister');?>">Register</a> here</p>        
	      </div>      
	    </div>
	  </div>
	</section>
