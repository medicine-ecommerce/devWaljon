              ...
              <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="text-center"> 
                    ...
                    <a type="button" href="<?php echo base_url(); ?>assets/bulk_format/brand_bulk_format.xlsx" download="brand_bulk_format" class="btn btn active-btn btn-round" value="Download" onchange="fileUpload()">Download</a>
          ...
          <div class="bulk-upload-notes">
            <div class="">
              <div class="text-center"> 
                ...
                <a type="button" href="<?php echo base_url(); ?>assets/bulk_format/brand_bulk_format.xlsx" download="brand_bulk_format" class="btn btn active-btn btn-round" value="Download" onchange="fileUpload()">Download Excel</a>                    
...
<script type="text/javascript">
  ...
  $('#import_form').on('submit', function(event){
    ...
    $.ajax({
      url:"<?php echo base_url() ?>admin/upload_brand_bulk",
      method:"POST",
      ...
      success:function(data){                
        if(data.status){          
          $('#file').val('');
            if(user_type=='admin'){
              window.location.href = "<?php echo base_url() ?>admin/bulk_brand_uploaded_data";        
            }else{
              window.location.href = "<?php echo base_url() ?>vendor/bulk_brand_uploaded_data";        
            }
