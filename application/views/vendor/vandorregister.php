    ...
    left: 300px;">
          <section class="login_content">
            ...
            <form action="<?php echo base_url('admin/vandorLogin')?>" method="post" class="venderform">
              ...
              <div>
                <button type="button" class="btn btn-round btn-primary" style="color: #fff;background-color: #808080; border-color: #fff; width: 50%;">Registration</button>
              ...
              <div class="separator" style="color: white;">
                <p class="change_link">you  have already account?
                  <a href="<?php echo base_url('admin/vendorLogin')?>" class="to_register" style="color: white;"> Login Now </a>
                </p>
